...
const LottieScrollAnimation = dynamic(
    import("react-lottie-tools").then((data) => data.LottieScrollAnimation),
...
export default function ProcessAnimationMobile() {
    const rootClassName='ic-process-animation-mobile'
    return(
        <div className={rootClassName}>
            <LottieScrollAnimation className={`${rootClassName}__lottie`} height={4000} animation={animationData} frames={[0, 720]} />
