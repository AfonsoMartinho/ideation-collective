...
export default function ProcessAnimation() {
    ...
    return(
        <div id="trigger" ref={ref} className={`${rootClassName}__scrollable__container`}>
            <div className={`${rootClassName}__scrollable__text`} id="people">
                ...
                <div className={`${rootClassName}__scrollable__text__description desc`}>Ideation Collective is the design thinking agency that helped us define our brand and made us aware of the business possibilities within our industry.</div>
            </div>
            <div className={`${rootClassName}__scrollable__text`} id="people">
                <div className={`${rootClassName}__scrollable__text__slash`}>/</div>
            ...
            <div className={`${rootClassName}__scrollable__text`} id="people">
                <div className={`${rootClassName}__scrollable__text__slash`}></div>
                <div className={`${rootClassName}__scrollable__text__title`}></div>
                <div className={`${rootClassName}__scrollable__text__description desc`}></div>
            </div>
        </div>
    )
}